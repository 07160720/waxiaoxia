...
<?php 
 ...
 $sql = "SELECT * FROM waxiaoxia_column";
  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加栏目','add_column.php')"><i class="layui-icon"></i>添加</button>
        ...
        <tbody>
            <tr>
              ...
              <td class="td-manage" align="center">
                <button class="layui-btn layui-btn-sm layui-btn-warm"><a title="编辑"  onclick="x_admin_show('编辑栏目','edit_column.php?id=<?php echo $rowi['id']?>')" href="javascript:;">
