...
<head>
  ...
  <title>新闻动态_<?php echo $row_head['cfg_webname'] ?></title>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="breadcrumb">
            当前位置 : <a href="index.php">首页 > </a>新闻动态
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-xs-12 wow fadeInUp"  data-wow-duration="1s" data-wow-delay="0s">
        <div class="news just-test-div">
          <h4><a href="news-all.php?id=<?php echo $rowi['id'];?>" target="_blank"><?php echo $rowi['title'];?></a></h4>
